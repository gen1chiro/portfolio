...
import NavButton from '@/components/shared/nav/nav-button';
            ...
            >
                {
                    navContent.map((item, index) => (
                        <motion.li
                            ...
                            className={`relative flex justify-center items-center gap-4 sm:gap-6 hover:text-white ${currentIndex === index ? 'text-white' : ''}`}
                            whileTap={{
                                scale: 0.95
                            }}
                        >
